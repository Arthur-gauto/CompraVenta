                            ...
                            <div class="card-body p-4 m-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0">Para empezar</p>
                                    </div>
                                    <div class="avatar-sm">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4">
                                        <a href="login.php?c=1" class="btn btn-soft-success w-100">Ingresar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card plan-box mb-0">
                            <div class="card-body p-4 m-2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4">
                                        <a href="login.php?c=2" class="btn btn-soft-success w-100">Ingresar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
