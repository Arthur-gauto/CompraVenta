                                        ...
                                        <div class="card-header border-bottom-dashed p-4">
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <img src="../../assets/images/logo-dark.png" class="card-logo card-logo-dark" alt="logo dark" height="47">
                                                ...
                                                <div class="flex-shrink-0 mt-sm-0 mt-3">
                                                    ...
                                                    <h6 class="mb-0"><span class="text-muted fw-normal">Telefono: </span><span id="txttelf-no"> </span></h6>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end card-header-->
                                        ...
                                        <div class="card-body p-4">
                                            <div class="row g-3">
                                                <div class="col-lg-3 col-6">
                                                    <p class="text-muted mb-2 text-uppercase fw-semibold">Nro Compra</p>
                                                ...
                                                <div class="col-lg-3 col-6">
                                                    ...
                                                    <h5 class="fs-14 mb-0"><span id="txt_total"></span></h5>
                                                </div>
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="mt-4">
                                                <div class="alert alert-info">
                                                    <p class="mb-0"><span class="fw-semibold">Comentarios:</span>
